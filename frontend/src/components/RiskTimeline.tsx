...
const L: Record<Language, Record<string, string>> = {
  ...
  kn: {
    title: "ಯಾವಾಗ ಹೋಗುವುದು ಸುರಕ್ಷಿತ?",
    sub: "ಮುಂದಿನ 24 ಗಂಟೆಗಳ ಗಂಟೆಗಂಟೆಯ ಅಪಾಯ",
    best: "ಉತ್ತಮ ಸಮಯ",
    none: "ಮುಂದಿನ 24 ಗಂಟೆಗಳಲ್ಲಿ ಕಡಿಮೆ ಅಪಾಯದ ಸಮಯವಿಲ್ಲ",
    now: "ಈಗ",
    loading: "ಮುಂದಿನ 24 ಗಂಟೆಗಳನ್ನು ಓದಲಾಗುತ್ತಿದೆ…",
  },
};
